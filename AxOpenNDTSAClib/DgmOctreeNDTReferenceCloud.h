...
#ifndef DGM_OCTREE_NDT_REFERENCE_CLOUD_HEADER
#define DGM_OCTREE_NDT_REFERENCE_CLOUD_HEADER
...
class DgmOctreeNDTReferenceCloud : public GenericIndexedCloudPersist
{
public:
	...
	**/
	DgmOctreeNDTReferenceCloud(DgmOctreeNDT::NeighboursSet* associatedSet, unsigned count = 0);
...
protected:
	...
	DgmOctreeNDT::NeighboursSet* m_set;
